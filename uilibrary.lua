...
library.theme = {
    ...
    cursor = false,
    cursorimg = "",
    backgroundcolor = Color3.fromRGB(55, 47, 63),
    tabstextcolor = Color3.fromRGB(240, 240, 240),
    bordercolor = Color3.fromRGB(191, 127, 255),
    accentcolor = Color3.fromRGB(191, 127, 255),
    accentcolor2 = Color3.fromRGB(16, 31, 78),
    outlinecolor = Color3.fromRGB(191, 127, 255),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),
    sectorcolor = Color3.fromRGB(65, 57, 73),
    toptextcolor = Color3.fromRGB(191, 127, 255),
    topheight = 50,
    topcolor = Color3.fromRGB(65, 57, 73),
    topcolor2 = Color3.fromRGB(65, 57, 73),
    buttoncolor = Color3.fromRGB(25, 0, 49),
    buttoncolor2 = Color3.fromRGB(20, 0, 39),
